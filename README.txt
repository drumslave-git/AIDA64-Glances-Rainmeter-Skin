...
Graph update:
- CPU/MEM/GPU utilization panels include Rainmeter Line meters (0–100).
- AIDA64 VRAM panel (separate tile) shows used/total MB, progress bar, and VRAM % history.
...
- AIDA64 VRAM panel (separate tile): Value.SUSEDVMEM / SFREEVMEM / SVMEMUSAGE.
